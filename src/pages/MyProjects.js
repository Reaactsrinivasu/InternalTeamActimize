...
//     p: 4,
//   };
//   const handleOpen = (member, description) => {
...
//                           <RemoveRedEyeIcon sx={{ marginLeft: 'auto' }} onClick={() => handleOpen(item.members, item.description)} />
//                         </Controls.Grid>
...
//                   <Controls.Typography variant='h2' sx={{ textAlign: 'center' }}>Members</Controls.Typography>
//                   <Controls.Grid>
//                     {selectedMembers && selectedMembers.map((item) => (
//                       <>
//                         <Controls.Grid container sx={{ display: 'flex' }}>
//                           <Controls.Grid xs={6}>
//                             <Typography sx={{}}>{item.name}</Typography>
//                           </Controls.Grid>
//                           <Controls.Grid xs={6}></Controls.Grid>
//                           <Typography sx={{}}>{item.name}</Typography>
//                         </Controls.Grid>
//                       </>
//                     ))}
//                     <Controls.Grid>
//                       <Controls.Typography variant='h2' sx={{ textAlign: 'center' }}>Description</Controls.Typography>

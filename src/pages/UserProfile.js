...
const UserProfile = () => {
  ...
  return (
    ...
    <>
      ...
      <Controls.Grid rowSpacing={3} columnSpacing={3} container p={1} sx={{
        "&.MuiGrid-root": {
          paddingLeft: "11.7%",
        },
      }}>
        <Controls.Grid item xs={12} sm={12} md={3} >
          <Controls.Paper maxWidth="xlg" sx={{ width: '100%', height: '100%', boxShadow: '0px 10px 80px rgba(0, 0, 0, 0.1)',  backgroundColor:  theme.components.tables.styleOverrides.containedPrimarycardpaper.backgroundColor, borderRadius: '5px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', p: 4 }}>
            ...
            <Controls.Typography variant="h2"  sx={{ textAlign: 'center' }}>
              {users?.first_name} {users?.last_name}
            </Controls.Typography>
            <Controls.Typography gutterBottom  variant="subtitle1" component="div" sx={{ textAlign: 'center' }}> {users?.permanent_address}
            </Controls.Typography>
          </Controls.Paper>
        </Controls.Grid>
            ...
            <Controls.Grid rowSpacing={3} columnSpacing={3} container>
              ...
              <Controls.Grid item xs={12} sm={4} md={4} sx={{ width: '100%', height: '100%', }}>
                <Controls.Box component="span" sx={{ ml: 3, mt: 2, display: 'flex', flexDirection: 'row', justifyContent: 'flex-start' }}>
                  <Controls.EmailTwoToneIcon sx={{ width: '25px', height: '25px' }} />

                  <Controls.Typography variant="subtitle2"  sx={{ ml: 1 ,mt:0.5}}>
              ...
              <Controls.Grid item xs={12} sm={4} md={4} sx={{ width: '100%', height: '100%', }}>
                <Controls.Box component="span" sx={{ ml: 3, mt: 2, display: 'flex', flexDirection: 'row', justifyContent: 'flex-start' }}>
                  <Controls.PhonelinkRingTwoToneIcon sx={{ width: '25px', height: '25px' }} />
                  <Controls.Typography variant="subtitle2"  sx={{ ml: 1,mt:0.5 }}>
                    {users?.mobile_number}
                  </Controls.Typography>
                </Controls.Box>
              ...
              <Controls.Grid item xs={12} sm={4} md={4} sx={{ width: '100%', height: '100%', }}>
                <Controls.Box component="span" sx={{ ml: 3, mt: 2, display: 'flex', flexDirection: 'row', justifyContent: 'flex-start' }}>
                  <Controls.PinDropTwoToneIcon sx={{ width: '25px', height: '25px' }}  />
                  <Controls.Typography variant="subtitle2"  sx={{ ml: 1,mt:0.5 }}>

        ...
        <Controls.Grid container sx={{ justifyContent: 'end' }}>
          ...
          <Controls.Grid rowSpacing={3} columnSpacing={3} item xs={10.8} container p={1} sx={{
            ...
            <Controls.Grid  item xs={12} sm={12} md={9}>
              <Controls.Paper maxWidth="xlg" sx={{ width: '100%',  backgroundColor: theme.components.tables.styleOverrides.containedPrimarycardpaper.backgroundColor, boxShadow: '0px 10px 80px rgba(0, 0, 0, 0.1)', borderRadius: '5px', p: 5 }}>
                ...
                <Controls.Grid container>
                    <Controls.Grid item xs={12} sm={4} md={6} sx={{ width: '100%', }}>
                    ...
                    <Controls.Grid item xs={12} sm={12} md={12} sx={{ width: '100%', }}>
                      <Controls.Box component="span" sx={{ ml: 3, mt: 2, display: 'flex', flexDirection: 'row', justifyContent: 'flex-start' }}>
